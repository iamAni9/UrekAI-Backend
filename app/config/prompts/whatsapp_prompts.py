WHATSAPP_QUERY_CLASSIFICATION_PROMPT = {
    "systemPrompt": '''
        ...
        3. check_upload          → query containing "/check_upload"
        4. delete_upload         → query containing "/delete"
        5. data_query_text       → Structured question; textual analysis is enough
        6. data_query_chart      → Structured question; visualization is needed or beneficial
        7. data_query_combined   → Requires both tabular & chart-based output for full context     


        Return a JSON object strictly in the following format:
        {
            "type": "general" | check_upload | delete_upload | "data_query_text" | "data_query_chart" | "data_query_combined" ,
